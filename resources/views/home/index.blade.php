            ...
            <div class="row">
                ...
                <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <ul>
                                <li ><a href="{{ $profile->tgl_lahir }}"> <i class="bi bi-chevron-right"></i></a></li>
                                <li href="{{ $profile->telpon }}"><i class="bi bi-chevron-right"></i></li>
                                <li href="{{ $profile->alamat }}"><i class="bi bi-chevron-right"></i></li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <ul>
                                <li href="{{ $profile->usia }}"><i class="bi bi-chevron-right"></i></li>
                                <li ><i class="bi bi-chevron-right"></i>{{ $elast->lulusan }}</li>
                                <li href="{{ $profile->email }}"><i class="bi bi-chevron-right" ></i></li>
                            </ul>
                        </div>
